    ...
    DeepakBotInc.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                //welcome\\
        let nama = await DeepakBotInc.getName(num)
...
XeonLft = await getBuffer(ppuser)
                ...
                xeonbody = `Hello @${xeonName.split("@")[0]},
I am *ZenitsuBot*,
...
DeepakBotInc.sendMessage(anu.id, buttonMessage, {quoted:unicorndoc})
